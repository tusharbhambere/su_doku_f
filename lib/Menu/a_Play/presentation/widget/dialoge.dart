...
void fadeDialog(BuildContext context, String content, String no, String yes,
    void Function()? onNo, void Function()? onYes) {
  fadePopup(
      context,
      AlertDialog(
        //title: Text(title),
      ...
      return WillPopScope(
        ...
        child: FadeTransition(
          ...
          child: SlideTransition(
              position: tween.animate(curvedAnimation), child: contents),
        ),
      );
    },
